int main()
{double pi=3.141592;struct Circle{double radius;double perimeter;double area;};struct Circle 123circle;cout<<"Enter the radius of the circle: ";cin>>circle.radius;
