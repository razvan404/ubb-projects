...
import OnwardTravel.models.ReservedSeat;
...
public class ReservationDbRepository implements ReservationRepository {
    ...
    @Override
    public UUID save(Reservation entity) throws DataLoadException {
        ...
        try (PreparedStatement preparedStatement1 = dbUtils.getConnection().prepareStatement(
            ...
            UUID reservationID = result.isEmpty() ? null : result.get(0);
    ...
    @Override
    public Reservation find(UUID identifier) throws DataLoadException {
        return null;
    }
    ...
    @Override
    public List<Reservation> findReservationsOnRide(Ride ride) throws DataLoadException {
            ...
            try (ResultSet resultSet1 = preparedStatement1.executeQuery()) {
                while (resultSet1.next()) {
                    ...
                    try (PreparedStatement preparedStatement2 = dbUtils.getConnection().prepareStatement(
                        ...
                        var result = DbUtils.findQueryResult(preparedStatement1, ClientDbRepository::extractClient);
