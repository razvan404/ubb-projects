...
public class UserDbRepository implements UserRepository {
    ...
    @Override
    public UUID save(User entity) throws DataLoadException {
        logger.traceEntry("User to save: {}", entity);
    ...
    @Override
    public User find(UUID identifier) throws DataLoadException {
        ...
        try (PreparedStatement preparedStatement = dbUtils.getConnection().prepareStatement(
            ...
            try (ResultSet resultSet = preparedStatement.executeQuery()) {
                System.out.println("After execute query" +resultSet.getStatement());
                if (resultSet.next()) {
    ...
    @Override
    public User tryLogin(String username, String password) throws DataLoadException {
