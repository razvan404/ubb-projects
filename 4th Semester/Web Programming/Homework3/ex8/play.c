...
int isNewUser() {
  return getIdFromCookie() == -1;
}

void clearIDCookie() {
  printf("Set-Cookie: id=%d", -1);
}
...
int main() {
  ...
  case 0: 
    ...
    break;
  case 1:
    printf("Eroare. Click <a href='play.cgi'>here</a> for a new game!");
    break;
  case 2:
    printf("Ati ghicit din %d incercari. Click <a href='play.cgi'>here</a> for a new game!</body></html>", getNoOfTries(id));
    destroy(id);
    break;
  case 3:
    printf("Prea mic!<br>\n"); printForm(id);
