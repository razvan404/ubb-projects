...
segment code use32 class=code
    start:
        ...
        mov esi, len2
        mov ecx, 0                                            ; pregatim parcurgerea celui de-al doilea sir
        std
        repeta2:                                       
            mov bl, [s2 + esi]                                   ; in bl vom lua al 'ebp'-lea element din al doilea sir, adica al 'esi'-lea element in ordine inversa
            mov [d + edi], bl                                    
            inc edi                                                  
            dec esi                                              ; la d atasam elementul din bl si incremenetam pe edi si pe esi
        end_repeta2:
        loop repeta2 
